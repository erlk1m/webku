...
Penjelasan: &s membuat referensi terhadap s (borrowing). calculate_length meminjam s tankan mengambil ownership. Setelah fungsi selesai, s masih valid dan bisa dipakai.
